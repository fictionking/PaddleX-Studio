    ...
    <div>
        ...
        <div v-if="currentModel.status === 'config'">
            <div class="step-header">
                <el-steps style="max-width: 900px; margin: 0 auto;" :space="300" :active="currentModel.step"
            ...
            <div class="step-body">
                ...
                <div v-if="currentModel.step === 0" style="align-items: center;text-align: center;">
                    ...
                    <div v-if="checking">
                        <el-steps style="max-width: 900px; margin: 0 auto;" :space="300" :active="checkstep"
